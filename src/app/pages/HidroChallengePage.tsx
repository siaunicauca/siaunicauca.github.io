...
const roadmapEvents = [
  ...
  { date: "26 septiembre", title: "Publicación de resultados parciales", description: "Publicación de resultados parciales de la competencia", rubrica: "", icon: <CalendarDays size={18} /> },
